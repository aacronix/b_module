...
if ($icon == null || $temp == null) {
    ...
    $OUTPUT .= "<div id='weather-block-$widgetId' class='b-widget v_1_2 clearfix' title='$widgetTitle. Ветер $windDirectionMessage'>
      ...
      <div class='weather-row clearfix'>
          <div class='weather-cell temperature'>
              <i class='wi wi-thermometer'></i> $temp <i class='wi wi-celsius temp-unit'></i>
          </div>
      </div>
    </div>
";
